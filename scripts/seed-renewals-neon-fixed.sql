-- Corrected SQL script to seed sample renewal data in Neon DB
-- This script handles the existing table structure
...
-- Step 4: Create sample policy holders (without id_number if column doesn't exist)
...
-- Step 6: Create vehicles for these policy holders
...
-- Step 9: Create some overdue renewals
INSERT INTO policy_renewals (
    policy_id,
    renewal_date,
    renewal_cycle_id,
...
-- Step 10: Create some converted renewals
INSERT INTO policy_renewals (
    policy_id,
    renewal_date,
    renewal_cycle_id,
...
-- Step 12: Show sample renewal data
SELECT 
    r.id,
    p.policy_number,
